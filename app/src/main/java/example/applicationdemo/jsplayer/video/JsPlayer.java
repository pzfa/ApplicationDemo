package example.applicationdemo.jsplayer.video;
...
import example.applicationdemo.jsplayer.bean.IVideoInfo;
import example.applicationdemo.jsplayer.danmu.DanmuAdapter;
import example.applicationdemo.jsplayer.danmu.DanmuModel;
import example.applicationdemo.jsplayer.danmu.DanmuView;
import example.applicationdemo.jsplayer.listener.OnPlayerCallback;
import example.applicationdemo.jsplayer.listener.OnVideoControlListener;
import example.applicationdemo.jsplayer.utils.NetworkUtils;
import example.applicationdemo.jsplayer.view.JsVideoControllerView;
import example.applicationdemo.jsplayer.view.JsVideoProgressOverlay;
import example.applicationdemo.jsplayer.view.JsVideoSystemOverlay;
import example.applicationdemo.jsplayer.view.VideoBehaviorView;
...
public class JsPlayer extends VideoBehaviorView {
    ...
    private void init() {
        ...
        danmu= (DanmuView) findViewById(R.id.danmu);
